...
return["map",w,P.af(z,!0,H.E(z,"T",0))]}if(!!z.$isfu)return this.dK(a)
if(!!z.$isf)this.dw(a)
...
n=u[m]
if(!(H.S(o,n)||H.S(n,o)))return!1}}return H.j9(a.named,b.named)},
...
return b},
ct:function(a){return J.bF(a,!1,null,!!a.$isU)},
...
return}throw"Unable to print message: "+String(a)}}],["","",,H,{"^":"",cY:{"^":"f;",$iscY:1,"%":"ArrayBuffer"},bk:{"^":"f;",$isbk:1,$isV:1,"%":";ArrayBufferView;c1|cZ|d0|c2|d_|d1|ag"},ku:{"^":"bk;",$isV:1,"%":"DataView"},c1:{"^":"bk;",
gj:function(a){return a.length},
$isU:1,
$asU:I.D,
$isK:1,
...
a[b]=c}},cZ:{"^":"c1+an;",$asU:I.D,$asK:I.D,
$asi:function(){return[P.aj]},
$ash:function(){return[P.aj]},
$isi:1,
$ish:1},d0:{"^":"cZ+cL;",$asU:I.D,$asK:I.D,
$asi:function(){return[P.aj]},
...
$ish:1,
$ash:function(){return[P.n]}},d_:{"^":"c1+an;",$asU:I.D,$asK:I.D,
$asi:function(){return[P.n]},
$ash:function(){return[P.n]},
$isi:1,
$ish:1},d1:{"^":"d_+cL;",$asU:I.D,$asK:I.D,
$asi:function(){return[P.n]},
$ash:function(){return[P.n]}},kv:{"^":"c2;",$isV:1,$isi:1,
$asi:function(){return[P.aj]},
$ish:1,
$ash:function(){return[P.aj]},
"%":"Float32Array"},kw:{"^":"c2;",$isV:1,$isi:1,
$asi:function(){return[P.aj]},
$ish:1,
$ash:function(){return[P.aj]},
"%":"Float64Array"},kx:{"^":"ag;",
...
return a}},
eH:function(a){return new P.iF(new P.Q(0,$.l,null,[a]),[a])},
iZ:function(){var z,y
...
c8:["dV",function(a,b){return new H.dB(this,b,[H.E(this,"T",0)])}],
c4:function(a,b){return P.af(this,!0,H.E(this,"T",0))},
bk:function(a){return this.c4(a,!0)},
gj:function(a){var z,y
z=this.gD(this)
for(y=0;z.p();)++y
...
$ish:1,
$ash:null},
O:{"^":"m;cf:style=,R:id=,cG:namespaceURI=,dv:tagName=",
...
"%":"HTMLImageElement"},
kh:{"^":"p;E:name=",$isO:1,$isf:1,$isF:1,$ism:1,"%":"HTMLInputElement"},
...
L:{"^":"hs;",$isL:1,$isP:1,$isb:1,"%":"DragEvent|MouseEvent|PointerEvent|WheelEvent"},
...
kO:{"^":"P;ai:error=","%":"SpeechRecognitionError"},
hk:{"^":"p;",
...
hs:{"^":"P;","%":"CompositionEvent|FocusEvent|KeyboardEvent|SVGZoomEvent|TextEvent|TouchEvent;UIEvent"},
...
try{v=J.N(a)}catch(t){H.w(t)}try{u=W.aB(a)
...
if(!!z.$isbK||!!z.$isP||!!z.$isbX||!!z.$isbT||!!z.$ism||!!z.$isV||!!z.$isc8)return a
...
z=!!z.$isbK||!!z.$isP||!!z.$isbX||!!z.$isbT||!!z.$ism||!!z.$isV||!!z.$isc8}else z=!1
if(z)return a
...
z=J.t(a)
if(!!J.k(z.gF(a)).$isO){y=this.bY(J.bJ(z.gF(a)))
...
this.d=new W.ac(new W.W(x.querySelectorAll("td"),[null]),!1,"click",[W.L]).a_(this.gfL())
J.q(x.querySelector("#text"),"Move a Ship")}if(this.a.b.c9()){z.a9(this.a.b)
this.ca()
this.d.J()
this.d=new W.ac(new W.W(x.querySelectorAll("td"),[null]),!1,"click",[W.L]).a_(this.gbb())}}}}},"$1","gd4",2,0,3,0],
dk:[function(a){var z,y,x,w
z=J.t(a)
if(!!J.k(z.gF(a)).$isO){y=this.bY(J.bJ(z.gF(a)))
...
if(x){this.d.J()
z=document
this.d=new W.ac(new W.W(z.querySelectorAll("td"),[null]),!1,"click",[W.L]).a_(this.gd4())
w=""+this.a.b.H()+" Ships left"
...
if(x-w>=z){this.d.J()
z=document
this.d=new W.ac(new W.W(z.querySelectorAll("tr"),[null]),!1,"click",[W.L]).a_(this.gd4())
...
x.bp()
W.a6(window,"resize",new B.f0(this),!1,W.P)
...
x=[null]
w=[W.L]
this.c=new W.ac(new W.W(z.querySelectorAll("#menu .button"),x),!1,"click",w).a_(this.gdF())
this.d=new W.ac(new W.W(z.querySelectorAll("td"),x),!1,"click",w).a_(this.gbb())
this.e=new W.ac(new W.W(z.querySelectorAll("#gameover .button"),x),!1,"click",w).a_(this.gdC())
...
init.types=[{func:1,args:[,]},{func:1,v:true},{func:1},{func:1,v:true,args:[W.L]},{func:1,v:true,args:[P.b],opt:[P.ao]},{func:1,args:[W.L]},{func:1,v:true,args:[{func:1,v:true}]},{func:1,ret:P.y,args:[P.n]},{func:1,args:[W.P]},{func:1,ret:P.cn,args:[W.O,P.y,P.y,W.cc]},{func:1,args:[P.y,,]},{func:1,args:[,P.y]},{func:1,args:[P.y]},{func:1,args:[{func:1,v:true}]},{func:1,args:[,P.ao]},{func:1,args:[P.n,,]},{func:1,args:[,],opt:[,]},{func:1,v:true,args:[,P.ao]},{func:1,args:[,,]},{func:1,args:[P.b1,,]},{func:1,v:true,args:[W.m,W.m]},{func:1,v:true,args:[W.P]},{func:1,args:[B.a0]},{func:1,v:true,args:[P.b]},{func:1,ret:P.b,args:[,]}]
